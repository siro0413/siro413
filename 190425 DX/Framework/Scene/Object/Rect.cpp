    ...
    : context(context)
{
	...
	tex1 = new Texture(context);
	tex1->CreateShaderResource("../_Assets/Texture/Tree.png");

	tex2 = new Texture(context);
	tex2->CreateShaderResource("../_Assets/Texture/forest1.png");
